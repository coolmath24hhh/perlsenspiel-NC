...
function buildPools() {
	...
	importantPool = [
		...
		{subject:"Bank alert notice", del:"Ignoring it doesn’t freeze time.", open:"It was just a verification check."},
		{subject:"Mom: call when free", del:"You keep meaning to.", open:"She picks up on the first ring."},
		{subject:"Doctor reminder", del:"You tell yourself you feel fine.", open:"Routine things matter too."},
		{subject:"Roommate message", del:"Tension grows in silence.", open:"It was simpler than expected."},
		{subject:"Advisor meeting time", del:"You keep putting it off.", open:"They’re more helpful than you feared."},
		{subject:"Package delivery notice", del:"You’ll forget until it’s gone.", open:"It’s waiting downstairs."},
		{subject:"Friend birthday today", del:"You’ll remember later tonight.", open:"They’re happy you reached out."},
		{subject:"Utilities payment due", del:"The worry lingers anyway.", open:"It’s taken care of."},
		{subject:"Health insurance update", del:"Paperwork piles up quietly.", open:"Nothing urgent changed."},
		{subject:"Dad sent a message", del:"You stare at the notification.", open:"He just wanted to check in."}
	...
	spamPool = [
		...
		{subject:"Your account reward!", del:"Nothing was ever waiting.", open:"Another trick headline."},
		{subject:"Top 5 habits of success", del:"You skip the advice.", open:"Now you feel behind."},
		{subject:"Exclusive crypto tip", del:"The hype fades instantly.", open:"It sounds risky."},
		{subject:"Dating match alert", del:"You avoid opening it.", open:"Another awkward introduction."},
		{subject:"Mega sale ending soon", del:"You close the tab.", open:"The countdown feels fake."},
		{subject:"Daily productivity email", del:"You choose quiet instead.", open:"Now you feel guilty."},
		{subject:"Streaming service promo", del:"You already have too many.", open:"Another trial period."},
		{subject:"Click here to win!", del:"You don’t fall for it.", open:"Of course it’s fake."},
		{subject:"Influencer life update", del:"You mute the newsletter.", open:"Everyone seems happier."},
		{subject:"Trending news digest", del:"Peace returns briefly.", open:"More chaos than clarity."}
	].map(m => ({...m, type:SPAM}));
	...
	unclearPool = [
		...
		{subject:"Unknown number called", del:"You ignore it.", open:"No voicemail left."},
		{subject:"Re: earlier message", del:"You let it fade.", open:"You don’t remember the thread."},
		{subject:"Draft saved automatically", del:"You delete it.", open:"You don’t remember writing this."},
		{subject:"Meeting invite?", del:"You decline silently.", open:"No context attached."},
		{subject:"Voice message received", del:"You skip listening.", open:"It’s mostly static."},
		{subject:"Reminder: tomorrow", del:"You clear the alert.", open:"You still don’t know what it was."},
		{subject:"Shared file uploaded", del:"You remove the notification.", open:"The link no longer works."},
		{subject:"Missed notification", del:"You swipe it away.", open:"The app doesn’t show anything."},
		{subject:"Calendar conflict", del:"You cancel both.", open:"Neither meeting feels real."},
		{subject:"New contact added", del:"You don’t recognize the name.", open:"Maybe it was automatic."}
